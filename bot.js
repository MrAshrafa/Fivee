...
client.on("message", message => {
    if (message.content === (prefix + "help")) {
     const embed = new Discord.RichEmbed() 
         ...
         .setDescription(`**
          ------------------------------
          5bot : لضهار معلومات بوت
          5server : لضهار معلومات سيرفر
          5avatar : لضهار صورا حسابك
          5credits : لضهار كردت لخاص بك
          ------------------------------
          5ban : لتبنيد شخص من سيرفر
          5kick : لطرد شخص من سيرفر
          5gstart : لعمل قيف اوي في سيرفر
          5voicesetup {اسم الروم الذي تريده} : لعمل روم يعد اعضاء الولاين في رومات
          5clear : لمسح رسائل شات او روم
          5voicesetup : تقدر تسوي روم يعد اعضاء ون لاين الي بل رومات ولاكن البوت يعمل له اسم
          ------------------------------
       **  `)
            ...
            msg.edit(':eight_pointed_black_star:| **يتم الارسال الى الروم الان **').then(msg => {
              message.channel.awaitMessages(filter, {
                ...
                try {
                  ...
                  message.guild.channels.find("name" , room).send(' :heavy_check_mark: **FiveBot ✨** :heavy_check_mark:' , {embed: giveEmbed}).then(m => {
                     let re = m.react('🎉');
                     setTimeout(() => {
                    ...
                    message.guild.channels.find("name" , room).send(`**انتهت مسابقة الفاءز  ${gFilter}! في مسابقة \`${title}\`**` , {embed: {}})
                }, ms(duration));
            });
                } catch(e) {
